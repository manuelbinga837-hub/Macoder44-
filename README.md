...
## 🚀 Sobre mim
Estou iniciando minha jornada no mundo da programação e do desenvolvimento web. Adoro aprender novas tecnologias e resolver problemas reais através do código.

* 🎓 Atualmente estudando programação web e a linguagem C no colégio **Proglory da Graça**!
* 💡 Tenho grande interesse em Desenvolvimento Full-Stack e Criação de Jogos.
* 🌱 No momento, focado em dominar o ecossistema do JavaScript (HTML, CSS, JS e Node.js).
